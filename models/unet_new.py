...
def unet_new(model_name):
    ...
    # Block 2
    de_b2 = Conv2DTrans_block(input=de_b1, element_num=1, filters=(filter_factor*math.pow(2, 2)), kernel_size=kernel_size, strides=strides, padding=padding, kernel_initializer=kernel_initializer, activation=activation, block_name='decoder_b2')
