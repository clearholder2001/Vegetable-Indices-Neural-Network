...
def unet(model_name):
    ...
    x7 = Conv2D(64, (3, 3), padding='same', kernel_regularizer=regularizers.l2(cfg.L2_REGULAR), kernel_initializer='he_normal', name='block7_conv1')(x7)
    x7 = BatchNormalization(name='block7_bn1')(x7)
    x7 = Activation(activation, name='block7_ac1')(x7)
    x7 = Concatenate(axis=3)([x3, 7])
    ...
    x8 = Conv2D(32, (3, 3), padding='same', kernel_regularizer=regularizers.l2(cfg.L2_REGULAR), kernel_initializer='he_normal', name='block8_conv1')(x8)
    ...
    x9 = Conv2D(16, (3, 3), padding='same', kernel_regularizer=regularizers.l2(cfg.L2_REGULAR), kernel_initializer='he_normal', name='block9_conv1')(x9)
    ...
    x9 = Conv2D(16, (3, 3), padding='same', kernel_regularizer=regularizers.l2(cfg.L2_REGULAR), kernel_initializer='he_normal', name='block9_conv3')(x9)
